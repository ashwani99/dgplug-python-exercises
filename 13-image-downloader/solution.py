"""Write a function which will take any URL as an argument, and then check if there is any 
image in that URL, and if yes then save it in the current directory.
Use this as an argument https://dgplug.org/assets/img/header.png

Also, try to add file signature (https://en.wikipedia.org/wiki/List_of_file_signatures) check 
in the code. Refer https://en.wikipedia.org/wiki/List_of_file_signatures for more info."""
